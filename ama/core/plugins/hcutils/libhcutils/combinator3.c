...
static void add (char *ptr_out, char *ptr_in1, size_t len_in1, char *ptr_in2, size_t len_in2, char *ptr_in3, size_t len_in3)
{
...
int combinator32stdout(char* wl1, char* wl2, char* wl3)
{
  ...
  char *buf_in3 = (char *) malloc (sz_buf);
        ...
        for (ptr_in2 = buf_in2; ptr_in2 < max_in2; ptr_in2 += len_in2 + 1)
        {
          ...
          while (!feof (fd3))
          {
            ...
            for (ptr_in3 = buf_in3; ptr_in3 < max_in3; ptr_in3 += len_in3 + 1)
            {
              ...
              size_t len_add = vir_in1 + vir_in2 + vir_in3 + 1;

              if ((len_out + len_add) < SEGMENT_SIZE)
              {
                add (ptr_out, ptr_in1, vir_in1, ptr_in2, vir_in2, ptr_in3, vir_in3);
          ...
          while (!feof (fd3))
          {
            ...
            for (ptr_in3 = buf_in3; ptr_in3 < max_in3; ptr_in3 += len_in3 + 1)
            {
              ...
              else
              {
                ...
                fwrite (buf_out, 1, len_out, output);
